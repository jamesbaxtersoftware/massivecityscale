...
pub fn spawn_solar_system(
    ...
    let sun_mesh = meshes.add(Sphere::new(800.0).mesh().uv(32, 18)); // 800 km radius
    ...
    commands.spawn((
        ...
        Transform::from_xyz(-5000.0, 0.0, 0.0), // 5000 km to the left of origin
    ...
    let ring_mesh = meshes.add(
        Torus { minor_radius: 50.0, major_radius: 3000.0 } // major: 3000 km orbit
            .mesh()
            .minor_resolution(4)
            .major_resolution(64),
    );
